...
namespace Plat2d_2.EngineCore
{
    public class Sprite2d
    {
        ...
        public Vector2 CollisionScale = null; //size of the collision box
        ...
        public Sprite2d(Vector2 Position, Vector2 Scale, string Directory, string Tag, Vector2 realsize) : this(Position, Scale, Directory, Tag)
        {
            this.Position = Position;
            this.Scale = Scale;
            this.Directory = Directory;
            this.Tag = Tag;
            this.CollisionScale = realsize;
